...
$insert_orders = "Insert into user_orders (user_id,product_id,amount_due,invoice_number,total_products,order_date,order_status) values($user_id,$product_id,$subtotal,$invoice_number,$count_products,NOW(),'$status')";
